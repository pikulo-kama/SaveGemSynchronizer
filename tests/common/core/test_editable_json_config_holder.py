...
class TestEditableJsonConfigHolder:

    @pytest.fixture(autouse=True)
    def _setup(self, path_exists_mock):
        path_exists_mock.return_value = True


    @pytest.fixture
    def _test_config_path(self, tmp_path):
        return str(tmp_path / "test_config.json")


    def test_initialization_ensures_file_exists(self, save_file_mock, _test_config_path):
        """
    ...
    def test_set_value_updates_data_and_saves(self, save_file_mock, _test_config_path):
        """
    ...
    def test_set_fully_replaces_data_and_saves(self, save_file_mock, _test_config_path):
        """
