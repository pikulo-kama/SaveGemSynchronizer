...
class TestJsonConfigHolder:

    @pytest.fixture(autouse=True)
    def _setup(self, read_file_mock):
        read_file_mock.return_value = MockData


    def test_initialization_appends_extension_if_missing(self, read_file_mock):
        """
    ...
    def test_initialization_uses_provided_path_if_extension_present(self, read_file_mock):
        """
    ...
    def test_initialization_calls_before_file_open_and_load_data(self, mocker: MockerFixture, read_file_mock):
        """
    ...
    def test_get_value_retrieves_existing_property(self):
        """
    ...
    def test_get_value_returns_default_for_non_existing_property(self):
        """
    ...
    def test_get_returns_full_configuration_map(self):
        """
    ...
    def test_load_data_updates_internal_data(self, read_file_mock):
        """
