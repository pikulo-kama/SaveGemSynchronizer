...
def _setup(locales_mock, db_table_mock):
...
def test_should_call_callback_when_changing_game(_app_state, _state_change_callback, db_table_mock):
...
def test_should_call_callback_when_changing_locale(_app_state, _state_change_callback, db_table_mock):
...
def test_should_call_callback_when_changing_color_theme(_app_state, db_table_mock):
...
def test_should_call_callback_when_changing_time_format(_app_state, db_table_mock):
...
def test_should_use_default_time_format_if_not_provided(_app_state, db_table_mock):
...
def test_should_get_first_game_if_not_in_state(_app_state, db_table_mock):
...
def test_should_get_default_locale_if_not_in_state(_app_state, db_table_mock, prop_mock):
...
def test_refresh(_app_state, db_mock):
    _app_state.refresh()
