...
def mock_dependencies(url_retrieve_mock, logger_mock, resolve_temp_resource_mock):
    """
...
@pytest.fixture
def _user_state(app_context_mock, app_config_mock, _mock_holder_data):
...
@pytest.fixture
def _mock_holder_data(holder_mock):
    """
...
def test_user_initialization_and_properties(_test_user):
    """
...
def test_short_name(name, expected_short_name):
    """
...
def test_is_current_user_setter(_test_user):
    """
...
def test_download_photo_success(_test_user, url_retrieve_mock):
    """
...
def test_download_photo_none(url_retrieve_mock):
    """
...
def test_user_state_initialize_success(mocker: MockerFixture, _user_state):
    """
...
def test_user_state_by_email(_user_state):
    """
...
def test_upload_user_info_no_update(_user_state, gdrive_mock):
    """
...
def test_upload_user_info_with_update(_user_state, gdrive_mock, json_mock, holder_mock):
    """
