...
class TestProfilerUtil:
    ...
    def test_measure_time_logs_elapsed_time(self, logger_mock, time_mock, _dummy_function_to_time):
        """
    ...
    def test_measure_time_skips_when_level_is_disabled(self, logger_mock, time_mock, _dummy_function_to_time):
        """
    ...
    def test_measure_time_respects_custom_level(self, logger_mock, _info_level_function):
        """
