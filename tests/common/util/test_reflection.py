...
@pytest.fixture
def package_mock(mocker, module_patch):
    """
...
def test_get_members_finds_all_subclasses(package_mock):
    """
    ...
    found_members = set(get_members(package_mock, target_clazz))
...
def test_get_members_excludes_base_class(package_mock):
    """
    ...
    found_members = list(get_members(package_mock, target_clazz))
...
def test_get_members_excludes_non_subclasses(package_mock):
    """
