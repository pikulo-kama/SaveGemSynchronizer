...
def test_string_to_date_conversion(get_localzone_mock):
    """
...
def test_get_verbose_date_with_year(format_datetime_mock, app_state_mock):
    """
...
def test_get_verbose_date_without_year(app_state_mock, format_datetime_mock):
    """
...
def test_get_verbose_time_military_format(app_state_mock):
    """
...
def test_get_verbose_time_regular_format(app_state_mock):
    """
