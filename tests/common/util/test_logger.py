...
class TestLogger:
    ...
    def test_get_logback_fallback_to_savegem(self, _logger_module, read_file_mock, path_exists_mock,
                                             resolve_logback_mock):
        """
    ...
    def test_get_log_level_configured(self, mocker: MockerFixture, _logger_module, log_name, configured_level,
                                      expected_level):
        """
    ...
    def test_get_log_level_default(self, _logger_module, mocker):
        """
