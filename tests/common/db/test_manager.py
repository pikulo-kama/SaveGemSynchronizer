...
@pytest.fixture
def _database_table_mock(module_patch):
    return module_patch("DatabaseTable")


def test_db_singleton_creation():
    """
...
def test_connection_uses_resolve_app_data(resolve_app_data_mock):
    """
...
def test_table_returns_database_table_instance(module_patch, _database_table_mock, _in_memory_db_manager):
    """
...
def test_retrieve_table_calls_table_and_retrieve(_in_memory_db_manager, _database_table_mock):
    """
...
def test_execute_runs_sql_and_commits(_in_memory_db_manager):
    """
...
def test_select_runs_sql_and_returns_cursor(_in_memory_db_manager):
    """
...
def test_select_with_no_results(_in_memory_db_manager):
    """
...
def test_execute_logs_debug_info(_in_memory_db_manager, logger_mock):
    """
...
def test_select_logs_debug_info(_in_memory_db_manager, logger_mock):
    """
