...
class TestDaemon:
    ...
    def _setup(self, mocker: MockerFixture, json_config_holder_mock, prop_mock):
    ...
    def test_daemon_init_process_already_running(self, module_patch, path_exists_mock, sys_exit_mock, _mock_daemon):
        """
    ...
    def test_daemon_start_work_loop_no_auth(self, mocker: MockerFixture, path_exists_mock, time_sleep_mock,
                                            _mock_daemon):
        """
    ...
    def test_daemon_start_auth_required_delayed(self, mocker: MockerFixture, path_exists_mock,
    ...
    def test_daemon_start_work_exception_handling(self, mocker: MockerFixture, path_exists_mock, time_sleep_mock,
                                                  logger_mock, _mock_daemon):
        """
