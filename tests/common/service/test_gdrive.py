...
class TestGDrive:
    ...
    @pytest.fixture
    def _drive_service_mock(self, mocker: MockerFixture):
        """
    ...
    @pytest.fixture
    def mock_creds_valid(self, mocker: MockerFixture):
        """
    ...
    @pytest.fixture
    def _google_build_mock(self, module_patch, _drive_service_mock):
    ...
    @pytest.fixture
    def _media_file_upload_mock(self, module_patch):
        return module_patch("MediaFileUpload")


    @pytest.fixture
    def _media_base_upload_mock(self, module_patch):
        return module_patch("MediaIoBaseUpload")


    @pytest.fixture
    def _media_base_download_mock(self, module_patch):
        return module_patch("MediaIoBaseDownload")


    @pytest.fixture
    def _credentials_mock(self, module_patch):
        return module_patch("Credentials", autospec=True)


    @pytest.fixture
    def _request_mock(self, module_patch):
        return module_patch("Request")


    @pytest.fixture
    def _refresh_error_mock(self, module_patch):
        return module_patch("RefreshError")


    @pytest.fixture
    def _next_chunk_mock(self, module_patch):
        return module_patch("GDrive._GDrive__next_chunk")


    @pytest.fixture
    def _get_creds_mock(self, module_patch):
        return module_patch("GDrive._GDrive__get_credentials")


    def test_get_credentials_from_token_file(self, resolve_project_data_mock, resolve_app_data_mock, _credentials_mock,
    ...
    def test_get_current_user(self, _google_build_mock, _drive_service_mock, _get_creds_mock):
        """
    ...
    def test_query_metadata_success(self, _google_build_mock, _drive_service_mock, _get_creds_mock):
        """
    ...
    def test_query_metadata_http_error(self, logger_mock, http_error_mock, _google_build_mock, _drive_service_mock,
                                     _get_creds_mock):
        """
    ...
    def test_next_chunk_progress(self):
        """
    ...
    def test_next_chunk_no_status(self):
        """
    ...
    def test_next_chunk_no_subscriber(self):
        """
    ...
    def test_download_file_success(self, _google_build_mock, _next_chunk_mock, _media_base_download_mock,
                                   _drive_service_mock, _get_creds_mock):
        """
    ...
    def test_download_file_http_error(self, _google_build_mock, _next_chunk_mock, _media_base_download_mock,
                                      http_error_mock, _get_creds_mock):
        """
    ...
    def test_upload_file_success(self, _google_build_mock, _next_chunk_mock, _media_file_upload_mock,
    ...
    def test_upload_file_http_error(self, _google_build_mock, http_error_mock, _next_chunk_mock,
                                    _media_file_upload_mock, file_name_from_path_mock, _get_creds_mock):
        """
    ...
    def test_update_file_success(self, _google_build_mock, _next_chunk_mock, _media_base_upload_mock,
                                 _drive_service_mock, _get_creds_mock):
        """
    ...
    def test_update_file_http_error(self, _google_build_mock, _next_chunk_mock, _media_base_upload_mock,
                                    http_error_mock, _get_creds_mock):
        """
    ...
    def test_get_changes_no_start_token(self, _google_build_mock, _drive_service_mock, _get_creds_mock):
        """
    ...
    def test_get_changes_with_start_token(self, _google_build_mock, _drive_service_mock, _get_creds_mock):
        """
    ...
    def test_valid_credentials_found(self, _credentials_mock, logger_mock, resolve_app_data_mock):
        """
    ...
    def test_expired_credentials_refresh_successful(self, _credentials_mock, logger_mock, resolve_app_data_mock,
                                                    _request_mock):
        """
    ...
    def test_expired_credentials_refresh_failed(self, _credentials_mock, logger_mock, resolve_app_data_mock,
                                                _request_mock):
        """
...
class TestGoogleAuth:
    ...
    @pytest.fixture
    def _installed_app_flow_mock(self, module_patch):
        return module_patch("InstalledAppFlow")


    def test_is_authenticated_true(self, path_exists_mock, resolve_app_data_mock):
        """
    ...
    def test_is_authenticated_false(self, path_exists_mock, resolve_app_data_mock):
        """
    ...
    def test_authenticate_skip_if_token_exists(self, logger_mock, path_exists_mock, _installed_app_flow_mock):
        """
    ...
    def test_authenticate_raises_if_creds_missing(self, logger_mock, path_exists_mock):
        """
    ...
    def test_authenticate_success(self, logger_mock, save_file_mock, path_exists_mock, resolve_app_data_mock,
