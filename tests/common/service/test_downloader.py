...
@pytest.fixture
def _mock_game(mocker: MockerFixture):
    """
...
@pytest.fixture
def _mock_subscriber(mocker: MockerFixture):
    """
...
@pytest.fixture
def _downloader(_mock_subscriber):
    """
...
def test_download_success(path_exists_mock, copytree_mock, removedirs_mock, resolve_temp_file_mock,
...
def test_download_saves_directory_missing(path_exists_mock, _downloader, _mock_game, _mock_subscriber):
    """
...
def test_download_drive_metadata_missing(_downloader, _mock_game, _mock_subscriber, path_exists_mock):
    """
...
def test_backup_directory_with_existing_backup(copytree_mock, cleanup_directory_mock, removedirs_mock,
                                               path_exists_mock):
    """
...
def test_backup_directory_with_no_existing_backup(copytree_mock, cleanup_directory_mock, removedirs_mock,
                                                  path_exists_mock):
    """
