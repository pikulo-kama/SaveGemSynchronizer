...
@pytest.fixture
def mock_args(mocker: MockerFixture):
    """
...
@pytest.fixture
def mock_db_interaction(mocker):
    """
...
def mock_file_and_os(save_file_mock, path_join_mock, datetime_mock, _datetime_now):
    """
...
def test_get_extractors_filters_correctly(_custom_extractor_mock, get_members_mock):
    """
...
def test_invoke_extractor_uses_regular_by_default(mocker: MockerFixture, mock_args):
    """
...
def test_invoke_extractor_dispatches_to_custom_extractor(mocker: MockerFixture, module_patch, mock_args,
...
def test_regular_extractor_applies_filter(mock_args, db_mock, db_table_mock, save_file_mock):
    """
...
def test_regular_extractor_calls_post_extract(mocker, mock_args, save_file_mock, db_mock, db_table_mock):
    """
