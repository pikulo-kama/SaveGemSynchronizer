...
@pytest.fixture
def _invoke_file_mock(module_patch):
    return module_patch("invoke_importer_for_file")


@pytest.fixture
def _mock_args(mocker: MockerFixture):
...
@pytest.fixture
def _custom_importers(get_members_mock, _custom_importer_mock):
...
def _mock_ui_socket(module_patch):
    return module_patch("ui_socket")


def test_invoke_importer_for_file_dispatches_regular(mocker, _mock_args, read_file_mock, _custom_importers):
    """
...
def test_invoke_importer_for_file_dispatches_custom(mocker, _mock_args, read_file_mock, _custom_importer_mock,
                                                    _custom_importers):
    """
...
def test_invoke_importer_with_file_name_argument(module_patch, read_file_mock, _mock_args, _custom_importers,
...
def test_invoke_importer_with_definition_file_imports_new_files(mocker, _mock_args, db_table_mock, read_file_mock,
                                                                file_checksum_mock, _mock_ui_socket, _invoke_file_mock,
                                                                is_empty, set_first_call_count):
    """
...
def test_invoke_importer_with_definition_file_skips_unchanged_files(db_table_mock, _mock_args, _invoke_file_mock,
                                                                    read_file_mock,  file_checksum_mock):
    """
...
def test_regular_importer_exits_on_missing_file_name(_mock_args, db_mock, read_file_mock):
    """
...
def test_regular_importer_performs_truncate_and_insert(_mock_args, read_file_mock, db_table_mock, db_mock):
    """
...
def test_regular_importer_applies_filter_before_remove_all(_mock_args, read_file_mock, db_table_mock):
    """
...
def test_regular_importer_calls_format_data(mocker: MockerFixture, _mock_args, read_file_mock, db_table_mock):
    """
