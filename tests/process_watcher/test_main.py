...
class TestProcessWatcher:
    ...
    @pytest.fixture
    def _get_run_processes_mock(self, module_patch, _create_game_process: Callable) -> MagicMock:
        """
    ...
    def test_work_returns_early_if_no_state_change(self, app_context_mock, downloader_mock, _get_run_processes_mock,
    ...
    def test_work_updates_activity_log_for_running_games(self, app_context_mock, _get_run_processes_mock,
                                                         _create_game_process):
        """
    ...
    def test_work_skips_auto_actions_when_disabled(self, app_context_mock, downloader_mock, _get_run_processes_mock,
                                                   _create_game_process):
        """
    ...
    def test_auto_action_skip_if_game_auto_mode_disabled(self, app_context_mock, downloader_mock,
    ...
    def test_auto_action_skip_if_uptodate(self, app_context_mock, downloader_mock, _get_run_processes_mock,
                                          _create_game_process):
        """
    ...
    def test_auto_action_download_on_started(self, app_context_mock, downloader_mock, push_notification_mock,
                                             ui_socket_mock, _get_run_processes_mock, _create_game_process, tr_mock):
        """
    ...
    def test_auto_action_upload_on_closed(self, app_context_mock, uploader_mock, push_notification_mock,
                                          ui_socket_mock, _get_run_processes_mock, _create_game_process, tr_mock):
        """
