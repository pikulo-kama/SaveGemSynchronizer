...
def _setup(module_patch, sys_mock, sys_exit_mock, _startup_job_mock, google_auth_mock, gui_mock, app_context_mock,
...
@pytest.fixture
def _startup_job_mock(module_patch):
    return module_patch("StartupJob").return_value


def test_main_initializes_app_and_calls_services(_startup_job_mock, gui_mock, app_state_mock, sys_exit_mock,
...
def test_main_sets_up_state_change_ipc(app_state_mock, ui_socket_mock):
    """
...
def test_main_sets_up_gui_initialized_flag(gui_mock, flags_mock):
    """
...
def test_teardown_cleans_up_and_resets_flag(logger_mock, cleanup_directory_mock, flags_mock, mkdir_mock):
    """
...
def test_rebuild_resets_state_and_rebuilds_gui(module_patch, app_state_mock, gui_mock):
    """
