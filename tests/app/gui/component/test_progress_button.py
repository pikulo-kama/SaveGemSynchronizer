...
class TestQProgressPushButton:

    @pytest.fixture
    def _progress_button(self, qtbot):
        """
    ...
    def test_progress_button_initialization(self, _progress_button):
        """
    ...
    def test_set_progress_updates_state_and_properties(self, _progress_button, progress, expected_in_progress,
                                                       expected_enabled):
        """
    ...
    def test_resize_event_updates_progress_bar_geometry(self, mocker: MockerFixture, _progress_button):
        """
