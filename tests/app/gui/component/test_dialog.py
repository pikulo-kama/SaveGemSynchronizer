...
class TestQCustomDialog:

    @pytest.fixture
    def _parent_widget(self, qtbot):
        """
    ...
    @pytest.fixture
    def _dialog(self, _parent_widget, qtbot):
        """
    ...
    @pytest.fixture
    def _start_animation_mock(self, mocker: MockerFixture, _dialog, _orphan_dialog):
    ...
    def test_initial_defaults(self, _dialog):
        """
    ...
    def test_property_setters(self, _dialog):
        """
    ...
    def test_show_no_parent(self, qtbot, _start_animation_mock):
        """
    ...
    def test_show_geometry_calculation(self, _dialog, _parent_widget, _start_animation_mock):
        """
    ...
    def test_show_timer_logic(self, mocker: MockerFixture, _dialog):
        """
    ...
    def test_show_timer_ignored_if_zero(self, mocker: MockerFixture, _dialog):
        """
    ...
    def test_hide_animation_logic(self, _dialog, _start_animation_mock):
        """
    ...
    def test_exec_calls_show(self, mocker: MockerFixture, _dialog):
        """
