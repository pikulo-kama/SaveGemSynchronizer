...
class TestCustomComponentMixin:
    ...
    @pytest.fixture
    def _test_widget(self, qtbot, _test_widget_class, _mock_metadata):
        """
    ...
    @pytest.fixture
    def _mock_metadata(self, mocker: MockerFixture):
        """
    ...
    def test_metadata_getter_setter(self, mocker: MockerFixture, qtbot, _test_widget_class):
        """
    ...
    def test_apply_alignment_with_layout(self, mocker: MockerFixture, _test_widget, _mock_metadata):
        """
    ...
    def test_apply_alignment_no_layout(self, _test_widget):
        """
    ...
    def test_enable_interactable(self, _test_widget, _mock_metadata):
        """
    ...
    def test_enable_non_interactable(self, _test_widget, _mock_metadata):
        """
    ...
    def test_disable_interactable(self, _test_widget, _mock_metadata):
        """
    ...
    def test_refresh_no_metadata(self, _test_widget, _mock_metadata, resolve_content_mock):
        """
    ...
    def test_refresh_content_and_tooltip(self, mocker: MockerFixture, _test_widget, _mock_metadata,
                                         resolve_content_mock):
        """
    ...
    def test_refresh_recursive(self, mocker: MockerFixture, _test_widget_class, _test_widget, _mock_metadata,
                               _test_child_widget):
        """
    ...
    def test_update_styles(self, mocker: MockerFixture, _test_widget, _test_child_widget):
        """
    ...
    def test_should_not_refresh_if_not_metadata(self, mocker: MockerFixture, _test_widget, _test_child_widget):
