...
def test_paint_event_calls_internal_methods(mocker: MockerFixture, qtbot, painter_mock):
    """
...
def test_init_sets_fixed_height(qtbot):
...
def test_set_fixed_height_ignored(qtbot):
    """
...
def test_paint_h_divider_geometry(qtbot, painter_mock):
    """
...
def test_init_sets_fixed_width(qtbot):
...
def test_set_fixed_width_ignored(qtbot):
    """
...
def test_paint_v_divider_geometry(qtbot, painter_mock):
    """
    Verifies the rectangle geometry calculations.
    """
