...
from src.savegem import QIconWrapper


class TestQCustomPushButton:

    @pytest.fixture
    def _custom_button(self, qtbot):
        """
    ...
    def test_custom_push_button_initialization(self, _custom_button):
        ...
        assert _custom_button.property(KamaAttr.Disabled) == QBool(False)
        assert QPushButton.isEnabled(_custom_button) is True


    def test_set_enabled_to_false_updates_state_and_property(self, mocker: MockerFixture, _custom_button):
        """
        ...
        assert _custom_button.property(KamaAttr.Disabled) == QBool(True)

        mock_polish.assert_called_once_with(_custom_button)


    def test_set_enabled_to_true_updates_state_and_property(self, mocker: MockerFixture, _custom_button):
        """
    ...
    def test_mouse_press_event_enabled_calls_super(self, mocker: MockerFixture, _custom_button):
        """
    ...
    def test_mouse_press_event_disabled_accepts_event(self, mocker: MockerFixture, _custom_button):
        """
    ...
    def test_key_press_event_enabled_calls_super(self, mocker: MockerFixture, _custom_button):
        """
    ...
    def test_key_press_event_disabled_accepts_event(self, mocker: MockerFixture, _custom_button):
        """
