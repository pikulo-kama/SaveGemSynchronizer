...
class TestThread:
    ...
    def _setup(self, gui_mock, qtbot):  # noqa
        gui_mock.is_blocked = False


    @pytest.fixture
    def mock_worker(self, mocker: MockerFixture):
        """
    ...
    def test_execute_in_blocking_thread_blocks_gui(self, gui_mock, qthread_mock, mock_worker):
        """
    ...
    def test_execute_in_blocking_thread_unblocks_on_finish(self, gui_mock, qthread_mock, mock_worker):
        """
    ...
    def test_execute_in_blocking_thread_avoids_redundant_execution(self, gui_mock, qthread_mock, mock_worker):
        """
    ...
    def test_execute_in_blocking_thread_connects_cleanup(self, qthread_mock, mock_worker):
        """
