...
CREATE TABLE IF NOT EXISTS ui_widgets (
    ...
    FOREIGN KEY (widget_type_id) REFERENCES setup_widget_type(widget_type_id) ON DELETE CASCADE,
    FOREIGN KEY (layout_type_id) REFERENCES setup_layout_type(layout_type_id) ON DELETE CASCADE
);
