...
from constants import TOKEN_FILE_NAME, SECRET_FILE_NAME, PROJECT_ROOT
...
class GCloud:
    ...
    def __get_credentials(self):
        ...
        if os.path.exists(os.path.join(PROJECT_ROOT, TOKEN_FILE_NAME)):
            creds = Credentials.from_authorized_user_file(os.path.join(PROJECT_ROOT, TOKEN_FILE_NAME), SCOPES)
